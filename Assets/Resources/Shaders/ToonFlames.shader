...
Shader "Shader Forge/ToonFlames" {
    Properties {
        ...
        _alphaValue ("alphaValue", Range(0, 1)) = 0.2
...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(_NoiseTexture_var.a*_node_9608_var.a*_alphaValue));
